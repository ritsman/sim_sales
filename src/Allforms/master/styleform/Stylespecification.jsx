...
export default function Stylespecification() {
                ...
                <Form method="post">
                  <div className="table-responsive">
                    <div className="styleHead">
                      <h6 className="pl_10">Specification</h6>
                    </div>
                    <Table
                      celled
                      striped
                    ...
                    >
                      <TableHeader>
                        <TableRow style={tableStyle}>
                          ...
                          <TableHeaderCell>Size Value</TableHeaderCell>
                    ...
                    <div className="text-center mt-3">
                      <a href="#" className="mr_10 upload_btn">
                        Submit
                      </a>
