...
const ItemCollection = () => {
  ...
  const updateCollection = async () => {
    ...
    try {
      await axios.put(
        `${config.API_URL}/api/gallery/updateItemCollection/${editingCollection._id}`,
        {
  ...
  const createCollection = async () => {
    ...
    try {
      await axios.post(
        `${config.API_URL}/api/gallery/createItemCollections/`,
        {
  ...
  const deleteCollection = async (collectionId) => {
    try {
      await axios.delete(
        `${config.API_URL}/api/gallery/deleteItemCollection/${collectionId}`
      );
